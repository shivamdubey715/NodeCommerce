...
exports.getProducts = (req, res, next) => {
  ...
  let totalItems; // Initialize totalItems
  
  Product.find()
    .countDocuments()
    .then(numProducts => {
      totalItems = numProducts; // Assign totalItems inside the first promise chain
      return Product.find()
    ...
    .then(products => {
      res.render("shop/product-list", {
        ...
        nextPage: +page + 1, // Convert to number
        previousPage: page - 1,
...
//     })
//     .catch((err) => {
//       console.error('Stripe Error:', err); // Log the actual Stripe error
